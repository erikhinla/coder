...
type sqlcQuerier interface {
	...
	GetPreviousTemplateVersion(ctx context.Context, arg GetPreviousTemplateVersionParams) (GetPreviousTemplateVersionRow, error)
	...
	GetTemplateVersionByID(ctx context.Context, id uuid.UUID) (GetTemplateVersionByIDRow, error)
	GetTemplateVersionByJobID(ctx context.Context, jobID uuid.UUID) (GetTemplateVersionByJobIDRow, error)
	GetTemplateVersionByTemplateIDAndName(ctx context.Context, arg GetTemplateVersionByTemplateIDAndNameParams) (GetTemplateVersionByTemplateIDAndNameRow, error)
	...
	GetTemplateVersionsByIDs(ctx context.Context, ids []uuid.UUID) ([]GetTemplateVersionsByIDsRow, error)
	GetTemplateVersionsByTemplateID(ctx context.Context, arg GetTemplateVersionsByTemplateIDParams) ([]GetTemplateVersionsByTemplateIDRow, error)
